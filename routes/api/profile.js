...
router.get("/me", auth, async (req, res) => {
    try{
        ...
        if(!profile) return res.status(400).json({msg: "Profile do not exist"});
...
[
    ...
    //build social object if you don't set social it will give you cant find undefined of youtube etc
